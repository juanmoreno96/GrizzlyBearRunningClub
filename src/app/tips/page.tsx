  ...
  return (
    <LoadingContent>
      <Head>
        ...
        <meta property="og:description" content="Expert running tips and training advice for all levels. Train smarter with our community." />
