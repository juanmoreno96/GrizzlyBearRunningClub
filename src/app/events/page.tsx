...
const Events = () => {
  ...
  const [activeFutureYear, setActiveFutureYear] = useState("2026");
  ...
  const futureEvents: Record<string, string[]> = {
    "2026": [
      "Bear Country Nigh Trek – September 4-5, 2026",
      "Laredo Marathon – November 2026",
      "San Antonio Marathon – December 4-6, 2026"
    ]
  };
...
src="/bannerPhotos/events-banner.jpg"
                  ...
                  <div className="relative z-10 p-8 flex flex-col justify-end h-full">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="text-white/80 font-label text-sm">December 4-6, 2026</span>
                    </div>
                    <h2 className="font-headline text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tighter">San Antonio Marathon &apos;26</h2>
                    <div className="flex flex-wrap items-center gap-6 mb-8 text-white/90">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-sm">San Antonio, Texas</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="md:col-span-4 group">
                <div className="h-[500px] w-full bg-surface-container-low rounded-xl overflow-hidden flex flex-col transition-all duration-300">
                  ...
                  <div className="p-8 flex flex-col justify-between flex-grow">
                    <div>
                      <span className="font-label text-secondary text-xs font-bold uppercase tracking-widest">Marathon</span>
                      <h3 className="font-headline text-2xl font-bold mt-2 leading-tight">Laredo Marathon</h3>
              ...
              <div className="md:col-span-8 group">
                <div className="h-full bg-surface-container-low rounded-xl overflow-hidden flex flex-col md:flex-row transition-all duration-300">
                  <div className="md:w-3/5 p-8 flex flex-col justify-center">
                    <span className="font-label text-secondary text-xs font-bold uppercase tracking-widest">Trail Run</span>
                    <h3 className="font-headline text-3xl font-extrabold mt-3 leading-tight">Bear Country Nigh Trek</h3>
                    <div className="grid grid-cols-2 gap-4 mt-8">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium">Sep 4-5, 2026</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-surface-container-highest flex items-center justify-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium">Waco, Texas</p>
                        </div>
                      </div>
                    </div>
  ...
  <div className="max-w-7xl mx-auto px-6">
    <div className="flex flex-col md:flex-row items-center justify-center w-full gap-8">
      ...
      <div className="md:w-1/2 flex flex-col gap-6">
        ...
        {/* Past Events Card */}
        <div className="text-center bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-lg">
       ...
       {/* Future Events Card */}
<div className="text-center bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-lg">
  <h2 className="text-3xl font-bold mb-4 text-white">Future Events</h2>
  <div className="flex justify-center mb-4 space-x-2">
    {Object.keys(futureEvents).map((year) => (
      <button
        key={year}
        className={`px-4 py-2 rounded ${activeFutureYear === year ? "bg-primary-container text-on-primary-container font-bold" : "bg-surface-container-high text-on-surface-variant hover:bg-surface-container-highest"}`}
        onClick={() => setActiveFutureYear(year)}
      >
        {year}
      </button>
    ))}
  ...
  <ul className="list-disc list-inside text-left space-y-2">
    {futureEvents[activeFutureYear]?.map((event, idx) => (
      <li className="text-lg text-white" key={idx}>{event}</li>
    ))}
  </ul>
</div>
